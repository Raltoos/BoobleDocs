...
//             // This is handled by a separate function to avoid saving on every keystroke
//             debouncedSaveToMongoDB(documentId, newContent);
//         });

//         // Handle cursor updates
//         socket.on("cursor-update", async ({ userId, position, color, documentId }) => {
...
//             if (cursorIndex >= 0) {
//                 cursors[cursorIndex] = { userId, position, color };
//             } else {
//                 cursors.push({ userId, position, color });
//             }
